...
#include "../method/method_global.h"   //ql
#include <iostream>
#include <fstream>

int main(int argc, char **argv) {
    Method::number_region_growing = std::atof(argv[5]);
    std::cout << "number_region_growing = " << Method::number_region_growing << std::endl;
    Method::lambda_model_complexity = std::atof(argv[6]);
    std::cout << "lambda_model_complexity = " << Method::lambda_model_complexity << std::endl;
    const std::string input_cloud_file = argv[1];
    const std::string output_file1 = argv[2];
    ...
    double ground_height = std::atof(argv[4]);
    double density = 0.2;
