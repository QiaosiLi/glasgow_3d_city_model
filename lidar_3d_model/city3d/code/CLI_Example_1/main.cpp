...
int main(int argc, char **argv) {
   ...
   // const std::string input_cloud_file = directory + "002.ply";
    ...
    // ql sample
    // input point cloud file name
    const std::string input_cloud_file = "E:/QL_2022/lidar_3d_city_modelling/building_lod2/test_data/NS5969/clip.ply";
    // input footprint file name
    const std::string input_footprint_file = "E:/QL_2022/lidar_3d_city_modelling/building_lod2/test_data/NS5969/274_z.obj";
    // output mesh file name
    const std::string output_file = "E:/QL_2022/lidar_3d_city_modelling/building_lod2/test_data/NS5969/274_z_result.obj";
