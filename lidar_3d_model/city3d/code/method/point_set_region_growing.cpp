...
)
{
	...
	const FT search_sphere_radius = FT(100) / FT(100); //original
	const FT max_distance_to_plane = FT(50) / FT(100); //original
	const FT max_accepted_angle = FT(30); //original
	//const FT search_sphere_radius = FT(50) / FT(100); // change 1
	//const FT search_sphere_radius = FT(25) / FT(100); // change 2
